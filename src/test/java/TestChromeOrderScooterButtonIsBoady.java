...
public class TestChromeOrderScooterButtonIsBoady {
    ...
    @Test
    public void ChromeTestOrderScooterButtonIsBoady(){

        driver.get("https://qa-scooter.praktikum-services.ru/");

        //Нажимаем на кнопку "Заказать" в теле
        HomePageSamokat objHomePage = new HomePageSamokat(driver);
        objHomePage.sckrolToAkkardionQuestions();
        objHomePage.clickButtonBodyToOrder();
        ...
        objWholsTheScooter.fillOutOrderForm("Antipiy","Усть-Марков", "ул. Шуйского, дом 18","Смоленская", "89156554585");
